    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          ...
          <p class="text-muted">Chez Fastfood, nous ne faisons pas dans la demi-mesure ! 
            Nos burgers sont XXL, nos frites sont dorées à souhait, et nos boissons sont rafraîchissantes.
             Venez déguster nos spécialités dans une ambiance dynamique et chaleureuse. Vous ne serez pas déçu !</p>
        </div>
      ...
      <?php foreach($Produits as $produit): ?> 
        <div class="col">
          <div class="card shadow-sm">
            <h3><?= $produit->nom ?></h3>
            <img src="<?= "images/" . $images['images'] ?>" style="width: 24%">
